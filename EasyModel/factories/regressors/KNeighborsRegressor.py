...
class KNeighborsRegressorFactory(AbsModelFactory):
    ...
    For more info, please visit http://scikit-learn.org/stable/modules/generated/sklearn.neighbors.KNeighborsRegressor.html
                                http://scikit-learn.org/stable/modules/generated/sklearn.model_selection.GridSearchCV.html

    Attributes:
        _reg: stores the model sklearn.neighbors.KNeighborsRegressor
    """
    ...
    def create_model(self, tuned_parameters, grid_search_parameters):
        ...
        self._reg = reg = GridSearchCV(KNeighborsRegressor(), tuned_parameters, **grid_search_parameters)
        return reg
