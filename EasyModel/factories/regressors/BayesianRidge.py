...
class BayesianRidgeFactory(AbsModelFactory):
    ...
    For more info, please visit http://scikit-learn.org/stable/modules/generated/sklearn.linear_model.BayesianRidge.html
                                http://scikit-learn.org/stable/modules/generated/sklearn.model_selection.GridSearchCV.html

    Attributes:
        _reg: stores the model sklearn.linear_model.BayesianRidge
    """
    ...
    def create_model(self, tuned_parameters, grid_search_parameters):
        ...
        self._reg = reg = GridSearchCV(BayesianRidge(), tuned_parameters, **grid_search_parameters)
        return reg
